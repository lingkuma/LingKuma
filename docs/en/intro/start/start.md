...
::: warning
I'm not a **beginner**, I already know **many** of these words, like CET-4. Can I do batch operations?
:::
...
If you have known word data from elsewhere, you can organize it into the following text format, one word per line
``` txt
apple
banana
orange
...
You can also download the English CET-4/6 vocabulary list below
...
Zhihu Wild List: [Large Language Model - Logic Ability Evaluation](https://zhuanlan.zhihu.com/p/1954578674109096588)
AI Leaderboard: [LMArena (VPN required)](https://lmarena.ai/)
## How do I get an API (interface)?
...
== Others
You can apply for large language model APIs from ChatGPT, Gemini, Claude, Qwen, DeepSeek yourself, and configure them as shown in the DeepSeek video tutorial to use.
